<template>
  <div class="container" :style="{'background-color': darkMode ? 'rgb(0, 0, 0)': 'rgb(127, 193, 196)'}">
    <div class="title" >
      <h1 :style="{'color': darkMode ? 'rgb(127, 193, 196)': 'rgb(0, 0, 0)'}">GreenFire</h1>
      <button class="ss-btn" v-on:click="handleClick" :style="{'background-color': darkMode ? 'rgb(127, 193, 196)': 'rgb(216, 248, 250)'}">ScreenShot</button>
      <button class="ss-btn" v-on:click="handleMode" :style="{'background-color': darkMode ? 'rgb(127, 193, 196)': 'rgb(216, 248, 250)'}">Dark Mode</button>
    </div>
